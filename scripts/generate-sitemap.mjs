...
const startswithAnimals = [
  ...
  "turtle", "snake", "lizard", "frog", "guinea-pig", "ferret", "chinchilla", "hedgehog",
  "mouse", "pig", "goat", "sheep", "cow", "chicken", "duck", "fox",
  "wolf", "bear", "lion", "tiger", "elephant", "panda", "monkey", "dolphin",
  "penguin", "owl", "eagle", "butterfly", "dragon", "unicorn", "phoenix", "deer",
  "raccoon", "squirrel", "otter", "koala", "zebra", "giraffe", "cheetah", "leopard",
  "shark", "whale", "octopus", "seal", "peacock", "flamingo", "swan", "parakeet",
  "cockatiel", "goldfish", "spider", "bee", "ant", "ladybug", "crab", "jellyfish",
  "starfish", "llama", "meerkat", "sloth", "hippo", "rhino", "gorilla", "crocodile",
  "kangaroo", "polar-bear", "walrus", "seahorse", "clownfish", "betta-fish", "canary", "gecko",
  "iguana", "chameleon", "axolotl", "capybara", "red-panda", "snow-leopard", "beluga", "narwhal",
  "manatee", "platypus", "wombat", "tasmanian-devil", "quokka", "fennec-fox", "serval", "ocelot",
  "caracal", "margay", "jaguar", "cougar", "bobcat", "lynx", "donkey", "yak",
  "bison", "buffalo", "moose", "elk", "caribou", "warthog", "baboon", "mandrill",
  "lemur", "gibbon", "orangutan", "coyote", "jackal", "hyena", "badger", "weasel",
  "mink", "beaver", "porcupine", "armadillo", "pangolin", "anteater", "tapir", "okapi",
  "pronghorn", "gazelle", "impala", "wildebeest", "cobra", "python", "anaconda", "rattlesnake",
  "komodo-dragon", "monitor-lizard", "skink", "salamander", "newt", "toad", "tree-frog", "macaw",
  "cockatoo", "lovebird", "budgie", "finch", "raven", "crow", "blue-jay", "cardinal",
  "robin", "pelican", "stork", "heron", "crane", "kingfisher", "hummingbird", "albatross",
  "puffin", "seagull", "cormorant", "salmon", "trout", "bass", "carp", "catfish",
  "perch", "stingray", "manta-ray", "lobster", "shrimp", "dragonfly", "firefly", "cricket",
  "grasshopper", "beetle", "wasp", "bumblebee", "millipede", "centipede", "scorpion", "tarantula"
];
